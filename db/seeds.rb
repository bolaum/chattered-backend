# create first user
roland = Nick.create!(name: 'roland', token: '123456', status: 'online')

# create second user
jake = Nick.create!(name: 'jake', token: '123456', status: 'online')
...
8.times do |n|
  ...
  random_users << Nick.create!(name: name, token: token, status: status)
end
